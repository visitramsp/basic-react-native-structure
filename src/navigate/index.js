    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          return route.name === 'Home' ? <MaterialIcons name={iconName} size={30} color={focused ? Colors.red100 : Colors.gray100} /> :
            <Icon name={iconName} size={24} color={focused ? Colors.red100 : Colors.gray100} />
        },
